...
int* merge(int lc, int* l, int rc, int* r){
    /*
    return the merged sorted array of two smaller sorted arrays (size and ptrs)
    */
...
int* sortArray(int* nums, int numsSize, int* returnSize){
    *returnSize = numsSize;// de reference ptr to the size of the mutated array and set = numsSize
